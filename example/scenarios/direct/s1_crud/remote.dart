// Direct / S1: CRUD — режим Remote
//
// Тот же сценарий через HTTP RPC к dart_vault серверу.
// Используется в production клиентах (Flutter, Dart CLI).
//
// Требует: dart_vault сервер на localhost:8765
// Запуск: dart run direct/s1_crud/remote.dart

import 'package:aq_schema/aq_schema.dart';
import 'package:dart_vault/dart_vault.dart';

void main() async {
  // 1. Инициализация — подключение к удалённому серверу
  ...
  print('✅ Direct S1 CRUD (remote) — OK');
